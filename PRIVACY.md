...
Wszystkie dane pochodzą z publicznych stron gry Travian Legends, które gracz już widzi na ekranie.

**Rozszerzenie NIE:**
- Nie śledzi aktywności gracza automatycznie
- Nie zbiera danych z innych stron (poza *.travian.com i polami)
- Nie rejestruje historii przeglądania

## 3. Przechowywanie danych

- **Na urządzeniu gracza**: Ustawienia (URL API, token) przechowywane w `chrome.storage.local`
- **Na serwerze sojuszu**: Wysłane dane przechowywane dla analityki sojuszu
...
- Wysyłanie danych odbywa się przez HTTPS
- Token API jest przechowywany wyłącznie lokalnie na urządzeniu
- Rekomendujemy używanie silnych haseł do kont sojuszu

## 6. Zmiany polityki

Zmiany w tej polityce będą publikowane na tej stronie. Używając rozszerzenia po zmianach, zgadzasz się z nową polityką.

## 7. Kontakt

W razie pytań dotyczących prywatności, skontaktuj się z administratorem sojuszu lub liderami aliansu UFOLODZY.
